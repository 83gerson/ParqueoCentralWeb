...
2. **Abrir** `ParqueoCentralWeb.sln` en Visual Studio 2019 o 2022.
3. **Restaurar los paquetes NuGet** (clic derecho en la solución y elegir *Restaurar paquetes NuGet*).
